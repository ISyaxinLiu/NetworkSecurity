...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        # PostgreSQL配置 - 修改这部分来适配PostgreSQL
        # 注意：这里使用TABLE_NAME而不是COLLECTION_NAME
        self.collection_name: str = training_pipeline.DATA_INGESTION_TABLE_NAME  # 这对应PostgreSQL的表名
        self.database_name: str = training_pipeline.DATA_INGESTION_DATABASE_NAME  # PostgreSQL数据库名
